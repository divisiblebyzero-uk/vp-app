            ...
            <div className="mb-16 mx-12 py-12 flex justify-between items-end mb-20">
                <div>
                    ...
                    <p className="font-body text-on-surface-variant max-w-md">
                        ...
                        Make sure to include the name of the print(s) you are interested in and the artist will contact you directly to arrange payment and delivery/collection of your work
                        (postage charges will be extra).</p>
                </div>
            </div>
